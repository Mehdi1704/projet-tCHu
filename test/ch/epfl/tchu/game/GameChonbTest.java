...
public class GameChonbTest {
    ...
    private void print(Map<PlayerId, TestPlayer2> players) {
        System.out.println("\nACTIONS");
    ...
    private void test(Map<PlayerId, TestPlayer2> players) {
    ...
    @Test
    void playException1() {
        TestPlayer2 p1 = new TestPlayer2(rng, List.copyOf(ChMap.routes()), 1);
        TestPlayer2 p2 = new TestPlayer2(rng, List.copyOf(ChMap.routes()), 1);
        ...
        assertThrows(IllegalArgumentException.class, () ->
                GameChonb.play(playersE, playerNamesE, SortedBag.of(ChMap.tickets()), rng));
    }
    ...
    playCheckWithRoutes() {
        ...
        TestPlayer2 p1 = new TestPlayer2(rng, claimableRoutes, 1);
        TestPlayer2 p2 = new TestPlayer2(rng, claimableRoutes, 1);
        Map<PlayerId, TestPlayer2> players = Map.of(PlayerId.PLAYER_1, p1, PlayerId.PLAYER_2, p2);

        GameChonb.play(Map.copyOf(players), playerNames, tickets, rng);
        print(players);    //49, 40
        test(players);
    }
    ...
    void playCheckWithNoRoutesNoTickets() {
        ...
        assertThrows(Error.class, () -> GameChonb.play(Map.copyOf(players), playerNames, tickets, rng));
        print(players);
        test(players);
    }
    ...
    void playCheckWithNoRoutesNoCards() {
        ...
        TestPlayer2 p1 = new TestPlayer2(rng, claimableRoutes, 2);
        TestPlayer2 p2 = new TestPlayer2(rng, claimableRoutes, 2);
        Map<PlayerId, TestPlayer2> players = Map.of(PlayerId.PLAYER_1, p1, PlayerId.PLAYER_2, p2);
...
final class TestPlayer2 implements Player {
    ...
    public TestPlayer2(Random rng, List<Route> claimableRoutes, int mode) {
        this.rng = rng;
